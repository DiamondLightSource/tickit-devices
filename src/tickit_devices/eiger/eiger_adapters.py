...
class EigerRESTAdapter(HttpAdapter):
    ...
    async def get_config(self, request: web.Request) -> web.Response:
        ...
        if hasattr(self.device.settings, param):
            data = serialize(construct_value(self.device.settings, param))
    ...
    async def get_status(self, request: web.Request) -> web.Response:
        ...
        if hasattr(self.device.status, param):
            data = serialize(construct_value(self.device.status, param))
        else:
            data = serialize(
                Value(value="None", value_type="string", access_mode=AccessMode.NONE)
            )
    ...
    async def initialize_eiger(self, request: web.Request) -> web.Response:
        ...
        return json_response(serialize(SequenceComplete.number(1)))
    ...
    async def arm_eiger(self, request: web.Request) -> web.Response:
        ...
        return json_response(serialize(SequenceComplete.number(2)))
    ...
    async def disarm_eiger(self, request: web.Request) -> web.Response:
        ...
        return json_response(serialize(SequenceComplete.number(3)))
    ...
    async def trigger_eiger(self, request: web.Request) -> web.Response:
        ...
        return json_response(serialize(SequenceComplete.number(4)))
    ...
    async def cancel_eiger(self, request: web.Request) -> web.Response:
        ...
        return json_response(serialize(SequenceComplete.number(5)))
    ...
    async def abort_eiger(self, request: web.Request) -> web.Response:
        ...
        return json_response(serialize(SequenceComplete.number(6)))
    ...
    async def get_stream_status(self, request: web.Request) -> web.Response:
        ...
        data = serialize(construct_value(self.device.stream.status, param))
    ...
    async def get_stream_config(self, request: web.Request) -> web.Response:
        ...
        data = serialize(construct_value(self.device.stream.config, param))
    ...
    async def get_monitor_config(self, request: web.Request) -> web.Response:
        ...
        data = serialize(construct_value(self.device.monitor_config, param))
    ...
    async def get_monitor_status(self, request: web.Request) -> web.Response:
        ...
        data = serialize(construct_value(self.device.monitor_status, param))
    ...
    async def get_filewriter_config(self, request: web.Request) -> web.Response:
        ...
        data = serialize(construct_value(self.device.filewriter_config, param))
    ...
    async def get_filewriter_status(self, request: web.Request) -> web.Response:
        ...
        data = serialize(construct_value(self.device.filewriter_status, param))
...
def json_response(obj: Any) -> web.Response:
    return web.json_response(obj, dumps=lambda data: json.dumps(data, default=str))
