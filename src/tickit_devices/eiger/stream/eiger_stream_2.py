...
STREAM_SETTINGS_MAP = {
    # Direct Mappings
    # TODO: These are ints, but they should be floats
    # https://github.com/DiamondLightSource/tickit-devices/issues/120
    ...
    # https://github.com/DiamondLightSource/tickit-devices/issues/121
